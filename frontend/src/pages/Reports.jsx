    ...
    return (
      <div className="min-h-screen bg-terminal-bg text-terminal-text p-6 md:p-10 font-mono">
        <header className="mb-10">
          <h1 className="text-4xl font-bold text-terminal-text mb-2">Research Reports</h1>
        ...
        <div className="flex flex-col items-center justify-center py-20">
          ...
          <h2 className="text-2xl font-bold text-terminal-text mb-2">No research reports yet</h2>
          <p className="text-[#6b7280] mb-6 text-center">
            Run a query in the Research page to generate your first report
          </p>
          <button
            onClick={() => navigate('/research')}
            className="px-6 py-3 bg-[#3b82f6] hover:bg-blue-700 rounded-lg font-semibold text-terminal-text transition-colors"
          >
            Go to Research
          </button>
        </div>
    ...
    <div className="min-h-screen bg-terminal-bg text-terminal-text p-6 md:p-10 font-mono">
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
        {reports.map((report) => (
          <div
            key={report.id}
            className="bg-terminal-surface border border-terminal-border rounded-xl p-6 hover:border-[#3b82f6]/50 transition-colors"
          >
            <div className="flex items-start justify-between mb-4">
              <h3 className="text-2xl font-bold text-terminal-text">{report.symbol}</h3>
            ...
            <div className="flex gap-2">
              <button
                ...
                className="flex-1 flex items-center justify-center gap-2 px-4 py-2 bg-[#3b82f6] hover:bg-blue-700 rounded-lg font-semibold text-terminal-text transition-colors text-sm"
              >
              ...
              <button
                ...
                disabled={pdfLoading}
                className="flex-1 flex items-center justify-center gap-2 px-4 py-2 bg-[#1f2937] hover:bg-[#374151] border border-[#374151] rounded-lg font-semibold text-terminal-text transition-colors text-sm disabled:opacity-50"
              >
      ...
      {selectedReport && (
        <div className="fixed inset-0 bg-black/80 flex items-center justify-center p-4 z-50">
          <div className="bg-terminal-surface border border-terminal-border rounded-xl max-w-4xl w-full max-h-[90vh] overflow-y-auto">
            <div className="sticky top-0 bg-terminal-surface border-b border-terminal-border p-6 flex items-center justify-between">
              <h2 className="text-2xl font-bold text-terminal-text">{selectedReport.title}</h2>
              <button
            ...
            <div className="p-6 space-y-6">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                <section className="bg-terminal-bg border border-terminal-border rounded-xl p-6">
              ...
              <section className="bg-terminal-bg border border-terminal-border border-l-4 border-l-[#3b82f6] rounded-xl p-6">
                <h3 className="text-lg font-semibold text-terminal-text mb-4">AI Research Narrative</h3>
